...
class IdentityProviderProxy: IdentityProvider {
    let identifier: String
    let name: String
    let externalIdentityProvider: (any OneginiSDKiOS.ExternalIdentityProvider)?
    static let `default` = IdentityProviderProxy(identifier: "919dcf6e-1d62-40c6-9b91-fb3e248757b3", name: "login-mobile.in.prod.onewelcome.net/")
